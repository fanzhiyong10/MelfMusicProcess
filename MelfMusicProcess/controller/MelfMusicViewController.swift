...
class MelfMusicViewController: UIViewController {
    ...
    @IBOutlet weak var speechMeter: MelfLevelMeterView!
    
    @IBOutlet weak var fxMeter: MelfLevelMeterView!
    
    @IBOutlet weak var voiceIOMeter: MelfLevelMeterView!
    ...
    private var audioEngine: MelfAudioEngine!
    ...
    func setupAudioEngine() {
        do {
            audioEngine = try MelfAudioEngine()
    ...
    @IBAction func slideFxOut(_ sender: UISlider) {
        let value = sender.value
        
        print("slider: \(value)")
        
        self.audioEngine.setVolumeOfFxPlayer(value)
    }
    
    @IBAction func slideSpeechOut(_ sender: UISlider) {
        let value = sender.value
        
        print("slider: \(value)")
        
        self.audioEngine.setVolumeOfSpeechPlayer(value)
